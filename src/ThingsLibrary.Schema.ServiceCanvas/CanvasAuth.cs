namespace ThingsLibrary.Schema.ServiceCanvas
{
    ...
    public class CanvasAuthSchema
    {
        ...
        /// </summary>
        [Required]
        public CanvasAuthJwtSchema? Jwt { get; init; } = null;
        ...
        /// Cookie details
        /// </summary>
        public CanvasAuthCookieSchema? Cookie { get; init; } = null;


        /// <summary>
        /// Constructor
        /// </summary>
        public CanvasAuthSchema() : base()
        {
            //nothing
        }
    }
