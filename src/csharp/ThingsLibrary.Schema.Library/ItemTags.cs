// ================================================================================
// <copyright file="ItemTags.cs" company="Starlight Software Co">
...
namespace ThingsLibrary.Schema.Library
{
    ...
    public class ItemTagsDto : IEnumerable<ItemTagDto>
    {
        private Dictionary<string, ItemTagDto> Items { get; set; } = [];
        ...
        public string this[string key]
        {
            ...
            set
            {
                ...
                {
                    this.Items[key] = new ItemTagDto(key, value);
                }
            }
        }
        ...
        public void Add(ItemTagsDto tags, bool append = false)
        {
            // nothing to do?
            if (tags == null) { return; }
        ...
        /// </summary>
        /// <param name="tag">Flat listing of Item Basic Tagss</param>
        ...
        {
            this.Add(new ItemTagDto(key, value));
        }
        ...
        {
            if(value is ICollection) { throw new ArgumentException("Collections are not supported for tag values."); }
        ...
        {
            if (this.Items.TryGetValue(key, out ItemTagDto? existingTag))
            {
                try
                {                    
        ...
        public IEnumerator<ItemTagDto> GetEnumerator()
        {
