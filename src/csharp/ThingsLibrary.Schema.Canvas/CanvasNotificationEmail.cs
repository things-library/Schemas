// ================================================================================
// <copyright file="CanvasNotificationEmail.cs" company="Starlight Software Co">
...
{
    public class CanvasNotificationEmail
    {
        /// <summary>
        /// Dependency Name
        /// </summary>
        ...
        /// </summary>
        [Display(Name = "From Address"), StringLength(200), Required, DataType(DT.EmailAddress)]
        ...
        public CanvasNotificationEmail()
        {
            //nothing
        }
    }
